        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Karyawan Tidak Hadir</li>
                </ol>
            </section>
            <!-- Main content -->
          ...
          ";
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <a href="attendance-sync.php" class="btn btn-success btn-sm btn-flat"><i class="fa fa-refresh"></i> Sync Data</a>
                            </div>
                            <div class="box-body table-responsive">
                                <table id="example1" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT *, employees.employee_id AS empid, attendance_tidakhadir.id AS attid FROM attendance_tidakhadir INNER JOIN employees ON employees.id=attendance_tidakhadir.employee_id ";
                                        // Filter Tanggal
