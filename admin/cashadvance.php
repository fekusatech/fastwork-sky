...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="pull-right">
                  <form method="POST" class="form-inline" id="payForm">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control pull-right col-sm-8" id="reservation" name="date_range" value="07/19/2023 - 08/18/2023">
                    </div>
                    <button type="button" class="btn btn-success btn-sm btn-flat" id="pinjaman"><span class="glyphicon glyphicon-print"></span> Cetak</button>
                  </form>
                </div>
              </div>
              <div class="box-body">
  ...
  <script>
    ...
    $('#pinjaman').click(function(e) {
      e.preventDefault();
      $('#payForm').attr('action', 'cashadvance_generate.php');
      $('#payForm').submit();
    });
  </script>
</body>
