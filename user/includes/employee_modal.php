    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="jatah_cuti" class="col-sm-3 control-label">Jatah Cuti</label>
            <div class="col-sm-9">
              <input type="number" class="form-control" id="jatah_cuti" name="jatah_cuti">
            </div>
          </div>
          <div class="form-group">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="employee_edit.php">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="number" class="form-control" id="edit_jatah_cuti" name="edit_jatah_cuti">
            </div>
          </div>
      </div>
      <div class="modal-footer">
